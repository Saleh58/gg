...
import dungeonmaps.MapSelectorGUI;
...
public class DnDCharGUI extends JFrame{
    ...
    private void addListeners(){
        ...
        createBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(raceComBox.getSelectedItem().equals("Human")){
                    tempCharacter = new HumanCharacter(nameField.getText(),new Fighter(), 19, 19);
        ...
        doneBtn.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                MapSelectorGUI.createAndShowGUI(bulletin, party);
            }
        });
    }
    ...
    public static void createAndShowGUI(String title, ArrayList<DnDCharacter> party, DnDBulletin bulletin){
